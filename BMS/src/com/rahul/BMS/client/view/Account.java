...
public class Account extends Composite {
	...
	dataServiceAsync.showCustomers(new AsyncCallback<ArrayList<com.rahul.BMS.shared.dto.CustomerDTO>>() {
	...
	void onClickSubmitAcnt(ClickEvent event) {
		...
		if ((!current.getValue() && !saving.getValue())
			...
			com.rahul.BMS.shared.dto.AccountDTO account = new com.rahul.BMS.shared.dto.AccountDTO();
