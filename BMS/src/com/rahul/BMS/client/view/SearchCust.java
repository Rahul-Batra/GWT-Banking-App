...
public class SearchCust extends Composite {
	...
	void onClickShowCustomer(ClickEvent event) {
		...
		dataServiceAsync.searchCustomer(searchcust.getText(),new AsyncCallback<ArrayList<com.rahul.BMS.shared.dto.CustomerDTO>>() {
			...
			@Override
			public void onSuccess(ArrayList<com.rahul.BMS.shared.dto.CustomerDTO> result) {
                ...
                for (com.rahul.BMS.shared.dto.CustomerDTO customer : result) {
