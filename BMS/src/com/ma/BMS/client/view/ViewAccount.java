...
public class ViewAccount extends Composite {
 ...
 public void onClickSrchAccount(ClickEvent event) {
		...
		dataServiceAsync.SearchAccount(Long.parseLong(srch.getText()),new AsyncCallback<ArrayList<com.ma.BMS.shared.dto.AccountDTO>>() {
			 ...
			 @Override
			public void onSuccess(ArrayList<com.ma.BMS.shared.dto.AccountDTO> result) {
				int row = 0;
                ...
                for (com.ma.BMS.shared.dto.AccountDTO account : result) {
	...
	public void viewaccnt() {
		...
		tableaccnt.setVisible(true);
			...
			dataServiceAsync.viewaccountData(new AsyncCallback<ArrayList<com.ma.BMS.shared.dto.AccountDTO>>() {
				 @Override
 			public void onFailure(Throwable caught) {
 				// TODO Auto-generated method stub
			...
			public void onSuccess(ArrayList<com.ma.BMS.shared.dto.AccountDTO> result) {
                ...
                for (final com.ma.BMS.shared.dto.AccountDTO account : result) {
