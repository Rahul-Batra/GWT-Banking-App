...
public class AccountCustomerDAO {
	...
	public static ArrayList<String> accntcust(Long actno)
	{
		...
		AccountCustomerDAO accountcustomerdao=new AccountCustomerDAO();
		 ...
		 ArrayList<com.ma.BMS.shared.dto.AccountDTO> reslt=new ArrayList<com.ma.BMS.shared.dto.AccountDTO>();
		 ArrayList<com.ma.BMS.shared.dto.CustomerDTO> resltcust=new ArrayList<com.ma.BMS.shared.dto.CustomerDTO>();
		 result=accountcustomerdao.viewacntcust(actno);
		 if(result.isEmpty())
				Window.alert("No data found for the given account");
		 else{
				
				for (com.ma.BMS.shared.dto.AccountCustomer acntcustomer : result)
				{
					if(acntcustomer.getIsPrimary()==true)
					{
						reslt=accountdao.SearchAccnt(acntcustomer.getAcctno());
						for (com.ma.BMS.shared.dto.AccountDTO account : reslt) 
							{
						...
						for (com.ma.BMS.shared.dto.CustomerDTO customer : resltcust) 
							{							
